...
const seedDB = async () => {
  ...
  for (let i = 0; i < 300; i++) {
    ...
    const camp = new Campground({
      ...
      description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati quasi delectus ratione quod quia? Iusto voluptas cupiditate aut temporibus architecto! Soluta aut rem quis qui repudiandae quas accusantium libero nulla.",
      price,
      geometry: {
        type: "Point",
        coordinates: [
